...
import { useCreatePostMutation, useUpdatePostMutation } from "@/lib/react-query/queriesAndMutation";
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  {...field}
                  className="shad-textarea custom_scrollbar"
                />
              </FormControl>
            ...
            <FormItem>
              ...
              <FormControl>
                <Input
                  ...
                  placeholder="#learn, #share, #social, #zin"
                  {...field}
                ></Input>
              </FormControl>
              <FormMessage className="shad-form_message" />
